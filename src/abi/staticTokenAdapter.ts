export const staticTokenAdapterAbi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_rewardCollector", type: "address" },
      { internalType: "string", name: "wrappedTokenName", type: "string" },
      { internalType: "string", name: "wrappedTokenSymbol", type: "string" },
    ],
