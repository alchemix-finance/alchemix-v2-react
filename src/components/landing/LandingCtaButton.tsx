  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "group relative z-10 inline-flex h-11 animate-buttonMovingGradientBg cursor-pointer items-center justify-center self-start rounded-xl border-0 px-8 py-5 font-sans text-xl font-semibold tracking-tight text-[#0B0D12] transition-all",
...
export const LandingClosingCtaButton = ({ delay = 0 }) => {
  ...
  return (
    <Link
      ...
      className={cn(
        // Base styles for the button
        "group relative z-10 inline-flex h-11 animate-buttonMovingGradientBg cursor-pointer items-center justify-center self-start rounded-xl border-0 px-8 py-5 font-sans text-xl font-medium tracking-tight text-[#1BEAA5] transition-all",
        // Apply multiple background layers
        "bg-[length:200%] [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent]",
        // Background layers for the gradient effect
